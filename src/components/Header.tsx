...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-200/60 supports-[backdrop-filter]:bg-white/75 transition-colors">
      {/* Main Header Bar */}
