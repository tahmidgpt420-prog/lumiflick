...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/70 backdrop-blur-xl shadow-sm border-b border-gray-200/50 supports-[backdrop-filter]:bg-white/60 transition-colors">
      {/* Main Header Bar */}
